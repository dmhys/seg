...
StaticPointcloudRenderer::StaticPointcloudRenderer(
  ...
  pimpl.reset(
      new gl::GeneralRenderer(gl::GeneralRenderer::BufferType::STATIC,
  ...
  if (color_mode == ColorMode::UNIFORM) {
    ...
    if (ImGui::TreeNode("Color Options")) {
      ImGui::SliderFloat("Hue From", &visualize_hue_from, 0.0f, 1.0f,
                         "Hue From   = %.2f");
      ImGui::SliderFloat("Hue To", &visualize_hue_to, 0.0f, 1.0f,
                         "Hue To     = %.2f");
      ImGui::SliderFloat("Saturation", &visualize_saturation, 0.0f, 1.0f,
                         "Saturation = %.2f");
      ImGui::SliderFloat("Value", &visualize_value, 0.0f, 1.0f,
                         "Value      = %.2f");

      ImGui::SliderFloat("Z Min", &visualize_z_min, -30.0f, 0.0f,
                         "min z = %.2f");
      ImGui::SliderFloat("Z Max", &visualize_z_max, 0.0f, 200.0f,
                         "max z = %.2f");
